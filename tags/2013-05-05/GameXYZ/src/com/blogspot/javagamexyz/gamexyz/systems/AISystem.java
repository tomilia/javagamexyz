...
import com.blogspot.javagamexyz.gamexyz.AI.ActionSequencer;
import com.blogspot.javagamexyz.gamexyz.AI.GroupAI;
...
public class AISystem extends EntityProcessingSystem {
	...
	private void decidePlan(Entity e, AI ai) {
		...
		Array<Action2> availableActions = abilities.getActions(); 
